...
│   ├── TagNavigator.jsx     # Floating nav for tag filtering (Prev/Next) — counter doubles as "view all" trigger for NoteResultsOverlay. Tag-mode only; renders nothing for a search session.
