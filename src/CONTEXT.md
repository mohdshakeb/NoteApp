...
- **`TimelineRail.jsx` (~lines 56-77) and `TagsRail.jsx` (~lines 27-52) independently implement near-identical "sliding window of 25 centered on active item" clamping math.** Safe to extract to a shared util later; explicitly out of scope for the 2026-07-27 cleanup pass.
