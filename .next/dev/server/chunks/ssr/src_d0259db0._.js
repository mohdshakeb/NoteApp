...
const NoteApp = ({ user })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initDB"])(user.id).then(setDb);
        }
    }, [
        user
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initializeApp = async ()=>{
            try {
                setIsLoading(true);
                const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initDB"])(user.id);
                setDb(db);
                const fetchedNotes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNotes"])(db, user.id);
                if (Array.isArray(fetchedNotes) && fetchedNotes.length === 0) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDefaultNotes"])(db, user.id);
                    const initialNotes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNotes"])(db, user.id);
    ...
    const cleanupUnusedTags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((updatedNotes)=>{
    ...
    const handleKeyDown = (e)=>{
        ...
        if (selection.rangeCount > 0) {
            ...
            if (currentWord.startsWith('#')) {
                ...
                if (partialTag) {
                    const suggestions = Array.from(allTags).filter((tag)=>tag.toLowerCase().startsWith(partialTag)).slice(0, 5);
    ...
    const saveNoteToDb = async ()=>{
        try {
            ...
            if (editingNote) {
                ...
                setNotes((prevNotes)=>prevNotes.map((note)=>note.id === editingNote.id ? result : note));
                setEditingNote(null);
                savedNote = result;
            } else {
...
//# sourceMappingURL=src_d0259db0._.js.map